...
const Features = () => {
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10  max-w-7xl mx-auto md:pt-20 items-center justify-center">
        ...
        <div className="flex flex-col items-center justify-center max-w-80">
            ...
            <div className="mt-5 space-y-2 text-center">
                <h3 className="text-base font-semibold text-slate-700">Centralized Monitoring & Analytics</h3>
                <p className="text-sm text-slate-600">Administrators track project progress with department-wise insights, status reports, and analytics.</p>
            </div>
        </div>
        <div className="flex flex-col items-center justify-center max-w-80">
            ...
            <div className="mt-5 space-y-2 text-center">
                <h3 className="text-base font-semibold text-slate-700">Structured Project Collaboration</h3>
                <p className="text-sm text-slate-600">Students work in guided teams with clearly defined roles, tasks, and development stages.</p>
            </div>
        </div>
        <div className="flex flex-col items-center justify-center max-w-80">
            ...
            <div className="mt-5 space-y-2 text-center">
                <h3 className="text-base font-semibold text-slate-700">Guided Review & Feedback System</h3>
                <p className="text-sm text-slate-600">Project guides assign tasks, review submissions, and provide structured feedback at every stage.</p>
            </div>
        </div>
    </div>
</>
