...
const Dashboard = () => {
  ...
  const { teacherNotifications, studentNotifications } = useNotifications()
  ...
  }, [students, guides, projectGroups, tasks, departments, teacherNotifications, studentNotifications])
